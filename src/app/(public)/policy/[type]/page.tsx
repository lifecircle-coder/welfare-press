...
const POLICY_CONTENT: Record<string, { title: string, icon: any, content: string }> = {
    terms: {
        ...
        content: `
제 1 조 (목적)
본 약관은 [이어사리](이하 '회사')가 운영하는 인터넷 신문 [The 복](이하 '서비스')의 이용조건 및 절차, '회사'와 회원 간의 권리와 의무 등 기본적인 사항을 규정함을 목적으로 합니다.

제 2 조 (용어의 정의)
1. '서비스'란 '회사'가 이용자에게 제공하는 뉴스, 정보, 커뮤니티 등의 온라인 '서비스'를 의미합니다.
2. 회원이란 '회사'가 제공하는 '서비스'에 접속하여 본 약관에 따라 이용계약을 체결하고 '서비스'를 이용하는 고객을 말합니다.
3. 아이디란 회원의 식별과 '서비스' 이용을 위하여 회원이 정하고 '회사'가 승인하는 문자와 숫자의 조합을 의미합니다.

제 3 조 (약관의 효력 및 변경)
1. 본 약관은 '서비스'를 통하여 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력이 발생합니다.
2. '회사'는 관계 법령을 위배하지 않는 범위 내에서 본 약관을 개정할 수 있으며, 변경된 약관은 공지사항을 통해 고지합니다.
3. 회원이 개정된 약관에 동의하지 않을 경우 이용계약을 해지할 수 있으며, 계속 이용 시 약관 변경에 동의한 것으로 간주합니다.

제 4 조 (회원 가입 및 계약 성립)
1. 이용계약은 이용자가 약관 내용에 대하여 동의를 하고 가입 신청을 한 후 '회사'가 이를 승낙함으로써 성립합니다.
2. '회사'는 실명이 아니거나 타인의 정보를 도용한 신청에 대하여 승낙을 거절하거나 사후에 계약을 해지할 수 있습니다.

제 5 조 ('서비스'의 제공 및 중단)
1. '서비스'는 연중무휴, 1일 24시간 제공함을 원칙으로 합니다.
2. '회사'는 시스템 정기점검, 설비 보수, 통신 장애 등 부득이한 사유가 있는 경우 '서비스'의 전부 또는 일부를 제한하거나 중지할 수 있습니다.

제 6 조 ('회사'의 의무)
1. '회사'는 본 약관이 정하는 바에 따라 지속적이고 안정적인 '서비스'를 제공하기 위하여 최선을 다합니다.
2. ''회사''는 '서비스' 제공과 관련하여 취득한 회원의 개인정보를 본인의 사전 승낙 없이 제3자에게 제공하거나 유출하지 않습니다.

제 7 조 (회원의 의무)
1. 회원은 관계 법령, 본 약관의 규정, 이용안내 및 '서비스'와 관련하여 공지한 주의사항을 준수하여야 합니다.
2. 회원은 타인의 권익이나 명예를 훼손하거나 '서비스'의 운영을 방해하는 행위를 해서는 안 됩니다.

제 8 조 (저작권의 귀속 및 이용제한)
1. '회사'가 작성한 저작물에 대한 저작권 및 기타 지적재산권은 '회사'에 귀속됩니다.
2. 이용자는 '서비스'를 이용하며 얻은 정보를 '회사'의 사전 승낙 없이 복제, 송신, 출판, 배포 등 영리 목적으로 이용하거나 제3자에게 이용하게 해서는 안 됩니다.

제 9 조 (분쟁 해결 및 관할권)
'회사'의 '서비스' 이용과 관련하여 발생한 분쟁에 대해서는 '회사'의 본사 소재지를 관할하는 법원을 전담 관할 법원으로 합니다.
        `
    },
    privacy: {
        title: '개인정보처리방침',
        ...
        content: `
[이어사리](이하 '회사') [The 복](이하 '서비스')는 이용자의 개인정보를 매우 중요하게 생각하며, 개인정보 보호법에 의거하여 다음과 같은 개인정보 처리방침을 운영하고 있습니다.
...
'회사'는 다음의 목적을 위하여 개인정보를 처리하며, 목적 이외의 용도로는 사용하지 않습니다.
...
전자우편 : eosr0509@gmail.com
    ...
    youth: {
        ...
        content: `
[이어사리](이하 '회사') [The 복](이하 '서비스')은 청소년이 건전한 인격체로 성장할 수 있도록 정보통신망 이용촉진 및 정보보호 등에 관한 법률에 따라 청소년 보호 정책을 수립하여 시행하고 있습니다.
...
'회사'는 청소년 보호 담당자 및 '서비스' 운영자들을 대상으로 관련 법령 및 청소년 유해 정보 발견 시 대처 방법 등에 대한 정기적인 교육을 실시하고 있습니다.

제 3 조 (피해 상담 및 고충 처리)
'회사'는 청소년 유해 정보로 인한 피해 상담 및 고충 처리를 위하여 전문 인력을 배치하고 피해 확산을 방지하기 위하여 노력하고 있습니다.
...
전자우편 : eosr0509@gmail.com
    ...
    copyright: {
        ...
        content: `
[이어사리](이하 '회사') [The 복](이하 '서비스')이 제공하는 모든 뉴스, 정보 등의 저작권은 '회사'에 있으며, 이용자들이 이를 무단으로 사용하는 것을 금지합니다.

제 1 조 (뉴스 저작권의 귀속)
'회사'가 직접 작성한 기사, 사진, 영상 등 모든 콘텐츠에 대한 저작권은 저작권법의 보호를 받으며 '회사'에 독점적으로 귀속됩니다.

제 2 조 (콘텐츠 이용의 제한)
1. 이용자는 '회사'의 사전 서면 승낙 없이 콘텐츠를 복제, 배포, 방송, 공중송신하거나 상업적으로 이용할 수 없습니다.
...
2. '회사'는 이용자의 게시물이 제3자의 저작권을 침해하는 경우 사전 통보 없이 해당 게시물을 삭제하거나 수정을 요구할 수 있습니다.

제 4 조 (저작권 침해 신고)
'회사'의 저작물을 무단으로 사용하거나 타인의 저작권 침해를 발견하신 경우 아래의 연락처로 신고해 주시기 바랍니다.
담당부서 편집국 운영팀
전자우편 : eosr0509@gmail.com
        `
    }
